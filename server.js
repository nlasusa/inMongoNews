...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/inMongoNews";
console.log('Loading...')
...
// A GET route for the saved site 
app.get("/saved", function (req, res) {
  console.log("getting saved")
  res.sendFile(path.join(__dirname + '/public/saved.html'));
});

// A GET route for scraping the main website
        ...
        $(".content-meta__headline__wrapper").find("a").each(function (i, element) {
            ...
            db.Article.create(result)
                ...
                .catch(function (err) {
                    ...
                    console.log(err);
                    res.json("article has already been added")
                });
        });
...
app.get("/articles/:id", function (req, res) {
  ...
  db.Article.findOne({
      ...
      .populate("note")
      .then(function (dbArticle) {
          // Succes in finding Article with id, send it back to the client
...
app.put("/articles/:id", function (req, res) {
  db.Article.findOneAndUpdate({
      ...
      .then(function (dbArticle) {
          // Successfully update an Article, send it back to the client
          res.json(dbArticle);
      })
      .catch(function (err) {
          // If an error occurred, send it to the client
